...
Config.LockPickDoorEvent = function() -- This function is called when a player attempts to lock pick a vehicle
    if exports['citra-parking']:InParkingLot() then return end
...
Config.PoliceAlertChance = 0.0      -- Chance of alerting police during the day
Config.PoliceNightAlertChance = 0.0 -- Chance of alerting police at night (times:01-06)
